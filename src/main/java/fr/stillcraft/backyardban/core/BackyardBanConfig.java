...
public final class BackyardBanConfig {
    ...
    // Checks/migrates all config & data files, then (re)loads them into this instance.
    public void checkAndLoad() {
        ...
        try {
            ...
            banlist = getConfig("data/banlist");
            baniplist = getConfig("data/baniplist");
            knownplayers = getConfig("data/knownplayers");
        } catch (IOException e) {
