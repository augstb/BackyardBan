 ...
 * instantiate arbitrary Java classes on load (CVE-2022-1471). config/locale/ban-data files are
 * meant to be admin-authored, but there's no reason to keep that footgun around.
 */
